const { kthSmallest, kthSmallestA, kthSmallestB, kthSmallestC } = require('../../../src/leetcode/n378/solution');
...
fun('kthSmallestC($matrix, $k)', ({ matrix, k, ans }) => {
    expect(kthSmallestC(matrix, k)).toBe(ans);
});
